# -*- coding: utf-8 -*-
"""
Created on Mon Sep 14 17:20:43 2020
...
def get_data():
    ...
    toll_location = pd.read_csv("D:\\Study\\DataScience\\Data\\MachineLearningData\\TrafficData\\toll_locations.csv")
    toll_collection = pd.read_csv("D:\\Study\\DataScience\\Data\\MachineLearningData\\TrafficData\\ahdt.csv")
    hourly_data = pd.read_csv('D:\\Study\\DataScience\\Data\\MachineLearningData\\TrafficData\\tollwise_final.csv')
...
def get_key(name):
   for key, value in toll_dict.items():
      if name == value:
         return key    
...
def main():
    ...
    toll_tuple = tuple(toll_dict.values())
    ...
    if st.button('Full Extents'):
        ...
        DATA_URL = "D:\\Study\\DataScience\\Projects\\DataApps\\ward.json"
        ...
        geojson = pdk.Layer('GeoJsonLayer', DATA_URL, opacity=0.8, stroked=False,filled=True,
        ...
        r = pdk.Deck(map_style='mapbox://styles/mapbox/light-v9',
                     layers=[point, polygon, geojson], initial_view_state=INITIAL_VIEW_STATE)
